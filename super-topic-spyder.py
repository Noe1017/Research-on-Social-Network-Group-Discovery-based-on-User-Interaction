...
def spider(username,password,book_name_xls,sheet_name_xls,keyword,maxWeibo,num,save_pic):
    ...
    # 修改为点击超话图标进入超话，减少错误
    elem = driver.find_element_by_xpath("//img[@src ='https://tvax2.sinaimg.cn/crop.0.0.1080.1080.180/007b8B1Dly8g5uokaqqm0j30u00u0wig.jpg?KID=imgbed,tva&Expires=1708688290&ssig=gwd2MJxid4']")
    elem.click()
    print("超话链接获取完毕，休眠2秒")
    time.sleep(2)
...
if __name__ == '__main__':
    username = "13110917608" #你的微博登录名
    password = "852369147Noe" #你的密码
